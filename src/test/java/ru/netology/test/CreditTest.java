    ...
    public class CreditTest {
        ...
        void shouldPaymentWithApprovedCard() {
            ...
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(2), getOwnerCard(), getCvc());
        ...
        void shouldPaymentWithApprovedCardExpires() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(0), getYearCard(0), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.successfulPaymentCreditCard();
            String actual = DbInteractionDbUtils.getStatusCredit();
        ...
        void shouldPaymentWithDeclinedCard() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getSecondNumberCard(), getMonthCard(0), getYearCard(1), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
        ...
        void shouldPaymentWithDeclinedCardExpires() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getSecondNumberCard(), getMonthCard(0), getYearCard(0), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.invalidPaymentCreditCard();
            String actual = DbInteractionDbUtils.getStatusCredit();
        ...
        void shouldPaymentWithInvalidCardNumber() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getInvalidNumberCard(), getMonthCard(2), getYearCard(1), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.invalidPaymentCreditCard();
        }
        ...
        void shouldPaymentWithInvalidCardNumberShort() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getInvalidShortNumberCard(), getMonthCard(2), getYearCard(1), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
        ...
        void shouldPaymentExpiredCard() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(0), getYearCard(-1), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
        ...
        void shouldPaymentIncorrectCardExpirationDate() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(-1), getYearCard(0), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
        ...
        void shouldPaymentCardValidMoreThanFiveYears() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(6), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidCardValidityPeriod();
        }
        ...
        void shouldPaymentCardInvalidYearOneDigit() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(2), getInvalidYearCard(), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidFormat();
        }
        ...
        void shouldPaymentInvalidOwnerCard() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(3), getInvalidOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
        ...
        void shouldPaymentInvalidOwnerCardInCyrillic() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(3),
        ...
        void shouldPaymentInvalidOwnerCardWithNumbers() {
            ...
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(3),
                    getInvalidOwnerCardWithDigit(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.incorrectOwner();
        }
        ...
        void shouldPaymentInvalidOwnerCardOneLetterName() {
            ...
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(3),
                    getInvalidOwnerCardWithOneLetter(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.incorrectOwner();
        }
        ...
        void shouldPaymentCardInvalidCvc() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(1), getYearCard(2), getOwnerCard(), getInvalidCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidFormat();
        }
        ...
        void shouldPaymentCardInvalidMonthOneDigit() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getInvalidMonthCardWithOneDigit(), getYearCard(2), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidFormat();
        }
        ...
        void shouldPaymentCardInvalidMonthInvalidPeriod() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCardInvalidPeriod(), getYearCard(2), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidCardValidityPeriod();
        }
        ...
        void shouldPaymentCardInvalidMonth() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getInvalidMonthCard(), getYearCard(2), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidCardValidityPeriod();
        }
        ...
        void shouldPaymentEmptyFieldMonth() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), null, getYearCard(2), getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidFormat();
        }
        ...
        void shouldPaymentEmptyFieldYears() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(2), null, getOwnerCard(), getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkInvalidFormat();
        }
        ...
        void shouldPaymentEmptyFieldOwner() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(2), getYearCard(3), null, getCvc());
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
        ...
        void shouldPaymentEmptyFieldCvc() {
            var startPage = new HomePage();
            CardInfo card = new CardInfo(
                    getFirstNumberCard(), getMonthCard(2), getYearCard(3), getOwnerCard(), null);
            var creditPage = startPage.paymentOnCredit();
            creditPage.getFillCardDetails(card);
            creditPage.checkEmptyField();
        }
